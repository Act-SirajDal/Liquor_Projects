...
class KauflandDePipeline:
    ...
    def process_item(self, item, spider):
        ...
        if isinstance(item, KauflandItem):
        ...
        if isinstance(item, Kaufland_dataItem):
            ...
            try:
                ...
                print(e)
                status = 'Duplicate'
            ins2 = f"""UPDATE {db.db_links_table} SET `status` = '{status}' WHERE `url` ='{item["Platform_URL"]}'"""
